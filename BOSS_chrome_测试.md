...
Do While True
    ...
    For i = 1 To 1 Step 1
        ...
        Keyboard.InputText({"wnd":[{"cls":"Chrome_WidgetWin_1","title":"*","app":"chrome"},{"cls":"Chrome_RenderWidgetHostHWND","title":"Chrome Legacy Window"}],"html":[{"tag":"INPUT","css-selector":"body>div>div>div>div>div>div>div>div>div>div>div.ui-dropmenu-list>div>input"}]},"测试",True,20,10000,{"bContinueOnError":False,"iDelayAfter":300,"iDelayBefore":500,"bSetForeground":True,"sSimulate":"message","bValidate":False,"bClickBeforeInput":False})
        // ui-dropmenu-label
        ...
        Do While bRet= False
            ...
            bRet = Text.Exists({"wnd":[{"cls":"Chrome_WidgetWin_1","title":"*","app":"chrome"},{"cls":"Chrome_RenderWidgetHostHWND","title":"Chrome Legacy Window"}],"html":[{"tag":"IFRAME","name":"recommendFrame"},{"tag":"DIV","parentid":"recommend-list"}]},"没有更多了","instr",1,10000,{"bContinueOnError":False,"iDelayAfter":300,"iDelayBefore":200,"bSetForeground":True})
        ...
        For y = 1 To iRetFather Step 1
            ...
            // 4. 求职期望
            expectJob = Regex.FindStr(arrayData[y-1][4],'测试',0)
            ...
            require_react = Regex.FindStr(arrayData[y-1][5],'性能测试|功能测试|压力测试|压测|脚本|开发脚本',0)

            // 9. 学历（大专|本科|硕士）
            certificate = cint(DigitFromStr(Regex.FindStr(arrayData[y-1][3],'本科|硕士',0)))
            ...
            If sRet <> "继续沟通" And findName ="" And workYear >= 3 And expectJob <> "" And age <=35 And summary ="" And working ="" And require_react <> "" And certificate <> "" And active_status<>""
