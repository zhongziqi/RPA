...
#icon("@res:26ulur7p-e8mp-be21-l2m7-c8rec2ciajms.png")
Mouse.Action({"wnd":[{"cls":"MozillaWindowClass","title":"*","app":"firefox"}],"html":[{"tag":"A","type":"desktop","parentid":"main","aaname":"推荐牛人                 "}]},"left","click",10000,{"bContinueOnError":False,"iDelayAfter":3000,"iDelayBefore":200,"bSetForeground":True,"sCursorPosition":"Center","iCursorOffsetX":0,"iCursorOffsetY":0,"sKeyModifiers":[],"sSimulate":"simulate","bMoveSmoothly":False})
#icon("@res:0pferu0t-0pj5-ffgj-eac2-9pnogg2tpg1g.png")
Mouse.Action({"wnd":[{"cls":"MozillaWindowClass","title":"*","app":"firefox"}],"html":[{"tag":"I","parentid":"recommendContent"}]},"left","click",10000,{"bContinueOnError":False,"iDelayAfter":1000,"iDelayBefore":200,"bSetForeground":True,"sCursorPosition":"Center","iCursorOffsetX":0,"iCursorOffsetY":0,"sKeyModifiers":[],"sSimulate":"simulate","bMoveSmoothly":False})
...
#icon("@res:bjj5c8vm-09uo-ilek-ggu5-vegckumngubm.png")
Mouse.Action({"wnd":[{"cls":"MozillaWindowClass","title":"*","app":"firefox"}],"html":[{"tag":"I","parentid":"recommendContent"}]},"left","click",10000,{"bContinueOnError":False,"iDelayAfter":1000,"iDelayBefore":200,"bSetForeground":True,"sCursorPosition":"Center","iCursorOffsetX":0,"iCursorOffsetY":0,"sKeyModifiers":[],"sSimulate":"simulate","bMoveSmoothly":False})
For i = 1 To 1 Step 1
    #icon("@res:ehu8ppdl-53d3-gn5t-gmuu-c2fnulat69ba.png")
    Mouse.Action({"wnd":[{"cls":"MozillaWindowClass","title":"*","app":"firefox"}],"html":[{"tag":"I","parentid":"recommendContent"}]},"left","click",10000,{"bContinueOnError":False,"iDelayAfter":1000,"iDelayBefore":200,"bSetForeground":True,"sCursorPosition":"Center","iCursorOffsetX":0,"iCursorOffsetY":0,"sKeyModifiers":[],"sSimulate":"simulate","bMoveSmoothly":False})
    TracePrint(i & ':i---')
    // ui-dropmenu-label
    #icon("@res:crhbpblm-4et7-g2d0-1bae-28efqn6nhtub.png")
    ...
    Mouse.Action({"wnd":[{"cls":"MozillaWindowClass","title":"*","app":"firefox"}],"html":[{"tag":"LI","parentid":"recommendContent"}]},"left","click",10000,{"bContinueOnError":False,"iDelayAfter":3000,"iDelayBefore":200,"bSetForeground":True,"sCursorPosition":"Center","iCursorOffsetX":0,"iCursorOffsetY":0,"sKeyModifiers":[],"sSimulate":"simulate","bMoveSmoothly":False})
    ...
    For y = 1 To iRetFather Step 1
        ...
        // 判断当前候选人是否被其他招聘顾问询问过
        #icon("@res:jeu1pnhm-b8a2-j8di-68od-pjkt23tpu058.png")
        ...
        sRet = UiElement.GetValue({"wnd":[{"cls":"MozillaWindowClass","title":"*","app":"firefox"}],"html":[{"tag":"IFRAME","name":"recommendFrame"},{"tag":"BUTTON","parentid":"recommend-list","idx":y-1}]},{"bContinueOnError":False,"iDelayAfter":300,"iDelayBefore":200})
        ...
        If sRet <> "继续沟通" And findName ="" And workYear >= 3 And expectJob <> "" And age <=30 And summary ="" And working ="" And require_react <> ""
            #icon("@res:gv0uhvdk-9a13-cv4k-k155-g2ereid4hl33.png")
